  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="学院" prop="deptId">
        <treeselect v-model="queryParams.deptId" :options="deptOptions" :show-count="true" placeholder="请选择学院" style="width: 180px" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['conversation:record:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['conversation:record:export']">导出</el-button>
      </el-col>
...
<script>
import { listRecord, getRecord, delRecord, exportRecord, addFollowUp, getFollowUpList } from "@/api/conversation/record"
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      this.download('conversation/record/export', {
