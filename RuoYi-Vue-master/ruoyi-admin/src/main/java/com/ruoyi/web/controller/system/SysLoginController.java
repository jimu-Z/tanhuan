...
public class SysLoginController {
    ...
    public AjaxResult getInfo() {
        ...
        // 补充学生信息（用于学生端个人中心）
        try {
            TalkStudent student = talkStudentRecordService.selectTalkStudentByCode(user.getUserName());
            if (student != null) {
                user.getParams().put("studentId", student.getStudentId());
                user.getParams().put("studentCode", student.getStudentCode());
                user.getParams().put("deptName", student.getDeptName());
                user.getParams().put("politicalStatus", student.getPoliticalStatus());
