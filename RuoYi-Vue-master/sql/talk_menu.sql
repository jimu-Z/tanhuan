...
-- 为角色分配菜单权限
-- 管理员角色（id=3）拥有全部菜单
INSERT INTO sys_role_menu VALUES(3, 2000),(3, 2001),(3, 2002),(3, 2003),(3, 2004),(3, 2005),(3, 2006),(3, 2010),(3, 2011),(3, 2012),(3, 2013),(3, 2014),(3, 2015),(3, 2020),(3, 2021),(3, 2022),(3, 2023),(3, 2024),(3, 2025);
-- 书记/副书记角色（id=4）拥有查看权限
INSERT INTO sys_role_menu VALUES(4, 2000),(4, 2001),(4, 2002),(4, 2006),(4, 2010),(4, 2011),(4, 2015),(4, 2020),(4, 2021),(4, 2025);
-- 辅导员/班主任角色（id=5）拥有查看和新增权限
INSERT INTO sys_role_menu VALUES(5, 2000),(5, 2001),(5, 2002),(5, 2006),(5, 2010),(5, 2011),(5, 2012),(5, 2015),(5, 2020),(5, 2021),(5, 2022),(5, 2025);
