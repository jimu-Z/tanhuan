...
INSERT INTO sys_menu VALUES(2010, '谈话管理', @talkMenuId, 2, 'management', 'talk/talkManagement/index', '', '', 1, 0, 'C', '0', '0', 'talk:session:list', 'form', 'admin', NOW(), '', NULL, '谈话管理（合并会话+记录CRUD）');
...
-- 原记录管理的子菜单（2021-2025）权限保留，用于谈话管理页面中的记录CRUD操作
...
-- 为角色分配菜单权限（已移除废弃的高级查询2041和记录管理2020）
-- 管理员角色（id=3）拥有全部菜单
INSERT INTO sys_role_menu VALUES(3, 2000),(3, 2001),(3, 2002),(3, 2003),(3, 2004),(3, 2005),(3, 2006),(3, 2010),(3, 2011),(3, 2012),(3, 2013),(3, 2014),(3, 2015),(3, 2021),(3, 2022),(3, 2023),(3, 2024),(3, 2025),(3, 2030),(3, 2040);
-- 书记/副书记角色（id=4）拥有查看权限
INSERT INTO sys_role_menu VALUES(4, 2000),(4, 2001),(4, 2002),(4, 2006),(4, 2010),(4, 2011),(4, 2015),(4, 2021),(4, 2025),(4, 2030),(4, 2040);
-- 辅导员/班主任角色（id=5）拥有查看和新增权限
INSERT INTO sys_role_menu VALUES(5, 2000),(5, 2001),(5, 2002),(5, 2006),(5, 2010),(5, 2011),(5, 2012),(5, 2015),(5, 2021),(5, 2022),(5, 2025),(5, 2030),(5, 2040);
...
-- 谈话标签管理（二级菜单，仅管理员可见）
INSERT INTO sys_menu VALUES(2080, '谈话标签管理', @talkMenuId, 13, 'talktag', 'talk/talkTag/index', '', '', 1, 0, 'C', '0', '0', 'talk:tag:list', 'tag', 'admin', NOW(), '', NULL, '谈话标签管理（管理员专用）');
SET @tagMenuId = 2080;
INSERT INTO sys_menu VALUES(2081, '标签查询', @tagMenuId, 1, '#', '', '', '', 1, 0, 'F', '0', '0', 'talk:tag:query', '#', 'admin', NOW(), '', NULL, '');
INSERT INTO sys_menu VALUES(2082, '标签新增', @tagMenuId, 2, '#', '', '', '', 1, 0, 'F', '0', '0', 'talk:tag:add', '#', 'admin', NOW(), '', NULL, '');
INSERT INTO sys_menu VALUES(2083, '标签修改', @tagMenuId, 3, '#', '', '', '', 1, 0, 'F', '0', '0', 'talk:tag:edit', '#', 'admin', NOW(), '', NULL, '');
INSERT INTO sys_menu VALUES(2084, '标签删除', @tagMenuId, 4, '#', '', '', '', 1, 0, 'F', '0', '0', 'talk:tag:remove', '#', 'admin', NOW(), '', NULL, '');

-- 管理员角色（id=3）拥有标签管理权限
INSERT INTO sys_role_menu VALUES(3, 2080),(3, 2081),(3, 2082),(3, 2083),(3, 2084);
