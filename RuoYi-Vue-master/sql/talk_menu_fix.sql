...
-- 预警提醒
INSERT IGNORE INTO sys_menu VALUES(2055, '预警提醒', 2000, 8, 'alert', 'talk/alertsV2/index', '', '', 1, 0, 'C', '0', '0', 'talk:alert:view', 'warning', 'admin', NOW(), '', NULL, '谈话预警提醒');
...
-- 谈话跟进
INSERT IGNORE INTO sys_menu VALUES(2075, '谈话跟进', 2000, 12, 'followup', 'talk/followup/index', '', '', 1, 0, 'C', '0', '0', 'talk:followup:list', 'list', 'admin', NOW(), '', NULL, '谈话跟进管理');
...
-- 验证：查询所有talk菜单
SELECT menu_id, menu_name, component, perms FROM sys_menu WHERE menu_id >= 2000 AND menu_id < 2100 ORDER BY menu_id;
